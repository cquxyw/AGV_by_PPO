...
class ppo(object):
    ...
    def save(self, TRAIN_TIME):
        dir_path = '/home/xyw/BUAA/Graduation/src/scout/model/simple/simple_%i.ckpt' %(TRAIN_TIME)
        self.saver.save(self.sess, dir_path)
    
    def save_suc(self, suc_time):
        dir_path = '/home/xyw/BUAA/Graduation/src/scout/model/simple/success/success_%i.ckpt' %(suc_time)
        self.saver.save(self.sess, dir_path)
    
    def restore(self, TRAIN_TIME):
        model_path = '/home/xyw/BUAA/Graduation/src/scout/model/simple/simple.ckpt'
