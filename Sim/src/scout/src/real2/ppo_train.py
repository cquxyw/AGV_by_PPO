    ...
    for TRAIN_TIME in range(50):
        ...
        for ep in range(EP_MAX):
            ...
            for t in range(EP_LEN):
                ...
                dis_ori, current_dis_from_des_point = env.compute_param()

                r = env.compute_reward(collide, current_dis_from_des_point, dis_ori, dis_temp)
