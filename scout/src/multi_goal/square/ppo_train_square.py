...
import subprocess
import ppo_algo_square as ppo_algo
import ppo_env_square as ppo_env
...
if __name__ == '__main__':
    ...
    for TRAIN_TIME in range(50):
        ...
        for ep in range(EP_MAX):
            ...
            last_dis_from_des_point, current_dis_from_center = env.compute_state()
            ...
            for t in range(EP_LEN):
                ...
                current_dis_from_des_point, current_dis_from_center = env.compute_param()

                # collide, current_dis_from_des_point to judge whether it is end of episode
                r = env.compute_reward(collide, current_dis_from_center, current_dis_from_des_point, last_dis_from_des_point)
